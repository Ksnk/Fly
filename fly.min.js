...
/*@if (@_jscript_version >= 1)
		engine.appendScript('http://ksnk.500mb.net/fly/excanvas-modified.js',function(){engine.excanvas_complete=true;});
		/*@end @*/
engine.appendCSSRules("#fly_prepare { position:absolute; visibility:hidden; top:0; left:0; } #debug {color:red; position:fixed; top:0; left:0;} .fly { position: absolute; top:0; left:0px; z-index:1000; }");var fly=document.createElement("div");fly.setAttribute("id","fly_prepare");fly.innerHTML='<img class="fly_src" id="fly_01" src="http://ksnk.500mb.net/fly/03.png">';document.body.appendChild(fly);
/*@if (@_jscript_version >= 1)
		    function xxx(){
